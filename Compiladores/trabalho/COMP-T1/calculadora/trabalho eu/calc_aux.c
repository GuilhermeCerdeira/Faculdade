...
struct ast *newflow(int nodetype, struct ast *cond, struct ast *tl, struct ast *el) {
  ...
  if (!a) {
    yyerror("sem espaco (out of memory)");
    exit(0);
  }
...
struct ast *newloopfor(struct ast *init, struct ast *cond, struct ast *inc, struct ast *list) {
  struct loopfor *a = malloc(sizeof(struct loopfor));
...
void treefree(struct ast *a)
{
    ...
    case 'S':
        free(((struct loopfor *)a)->init);
        free(((struct loopfor *)a)->cond);
        free(((struct loopfor *)a)->inc);
        if (((struct loopfor *)a)->list) treefree(((struct loopfor *)a)->list);
        break;
...
double eval(struct ast *a)
{
    ...
    case 'S': 
    	v = 0.0;
        if (((struct loopfor *)a)->init && ((struct loopfor *)a)->cond && ((struct loopfor *)a)->inc) {
            for (int i = (int)eval(((struct loopfor *)a)->init); eval(((struct loopfor *)a)->cond); i = eval(((struct loopfor *)a)->inc)) {
                v = eval(((struct loopfor *)a)->list);
            }
        }
    	break;
